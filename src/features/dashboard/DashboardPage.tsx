...
const QUOTES = [
  ...
  '但凡你有点本事，也不至于一点本事都没有。',
  '据研究，100%的死亡案例都与呼吸有关。',
  '如果你把一个东西翻过来，它的背面就在上面。',
  '这个价格上下浮动还是挺大的。',
  '你要说这个事儿，那还真就是这个事儿。',
  '关于这件事，我想说的都在这段话里了。',
  '据我所知，我一无所知。',
  '鲁迅说过："我没说过这句话。"',
  '每一个看起来像鸭子的东西，不一定都是鸭子。',
  '如果你觉得自己一无是处，别灰心，至少你的判断是准确的。',
  '成功不是终点，失败也不是终结，但放弃确实是放弃了。',
  '今天的明天就是昨天的明天。',
  '水喝多了，尿就会变多。——人生哲理',
  '你以为你以为的就是你以为的吗？',
  '这条名言没有任何意义，但你还是认真读完了。',
  '世界上没有两片完全相同的叶子，但可能有三片。',
  '你永远不知道意外和明天哪个先来，但你可以先吃个汉堡。',
  '当你觉得为时已晚的时候，其实确实是晚了。',
  '努力不一定成功，但不努力一定很舒服。',
  '别人笑我太疯癫，我笑别人看不穿——我看也不太穿。',
  '知识就是力量，但WiFi才是第一生产力。',
  '今天不想学习，明天也不想，但后天可能会想。',
  '你的坚持终将美好——如果你的坚持是指坚持吃外卖的话。',
]
